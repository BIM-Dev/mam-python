...
class Mam_e_master_data_generator:
    def __init__(self, file_dir, master_data_sheet_name, line_colors_sheet_name,
        ...
        self.station_mapping_dir = station_mapping_sheet_name
        ...
        # 20240618 暂时过滤非Admin用户不可选的点位 (针对所有非dev环境)
        ...
        self.df_station_mapping = pd.read_excel(self.file_dir, sheet_name=self.station_mapping_dir, dtype=str)
        # 20240716 从新表匹配L版station_id
        self.df_master_data = pd.merge(self.df_master_data, self.df_station_mapping, on=['线路中文名称', '站点中文名称'])



    def generate_line(self, df_master_data, df_line_colors):
    ...
    def generate_station(self, df_master_data):
        df_result = df_master_data[
            ['站点编号', '站点中文名称', '站点英文名称', '线路中文名称', '中文站点等级', 'L版station_id']].copy().drop_duplicates(
            inplace=False).rename(
            columns={'站点编号': 'code', '站点中文名称': 'name_cn', '站点英文名称': 'name_en',
                     '线路中文名称': 'line_code',
                     '中文站点等级': 'level_code',
                     'L版station_id': 'mapping_station_id'})
        df_result['env_info_code'] = self.env_info_code
        df_result['creator'] = self.user
        df_result['modifier'] = self.user
        return df_result
    ...
    def upload_data_to_db(self, connection_parameters, schema, delete_existed_rows, truncate_existed_table):
        df_line = self.generate_line(self.df_master_data, self.df_line_colors)
    ...
    def create_tables_in_db(self, drop_existed_table):
        sql_env_info = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.env_info
        (
        ...
        sql_line = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.line
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            code character varying(50) COLLATE pg_catalog."default",
            name_cn character varying(100) COLLATE pg_catalog."default",
        ...
        sql_asset = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.asset
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            code character varying(50) COLLATE pg_catalog."default",
            name_cn character varying(100) COLLATE pg_catalog."default",
        ...
        sql_level = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.level
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            code character varying(50) COLLATE pg_catalog."default",
            name_cn character varying(100) COLLATE pg_catalog."default",
        ...
        sql_asset_category = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.asset_category
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            code character varying(50) COLLATE pg_catalog."default",
            name_cn character varying(100) COLLATE pg_catalog."default",
        ...
        CREATE TABLE IF NOT EXISTS {self.schema}.estimated_impression
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            env_info_code character varying(50) COLLATE pg_catalog."default",
            month integer,
        ...
        sql_impression_report = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.impression_report
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
        ...
        sql_impression_report_item = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.impression_report_item
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
        ...
        sql_env_company = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.env_company
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            env_info_code character varying(50) COLLATE pg_catalog."default",
            name_cn character varying(100) COLLATE pg_catalog."default",
        ...
        sql_impression_report_access = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.impression_report_access
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            env_info_code character varying(50) COLLATE pg_catalog."default",
            impression_report_id integer,
        ...
        sql_error_code = f'''
        CREATE TABLE IF NOT EXISTS {self.schema}.error_code
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            code character varying(50) COLLATE pg_catalog."default",
        ...
        sql_actual_impression = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.actual_impression
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            env_info_code character varying(50) COLLATE pg_catalog."default",
            date date,
        ...
        sql_impression_report_record = f'''
            CREATE TABLE IF NOT EXISTS {self.schema}.impression_report_record
        (
            id integer NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 2147483647 CACHE 1 ),
            env_info_code character varying(50) COLLATE pg_catalog."default",
            report_id integer,
...
if __name__ == '__main__':
    ...
    # }
    schema = 'public'
    file_dir = r'C:\Users\lucy.wu\OneDrive - JCDECAUX\Documents\GitHub\mam-python\MAM E版本升级_WYK8.xlsx'
    ...
    env_info_code = 'mam-shanghai'
        ...
        # 示例数据上传至dev test环境
        # master_data_sheet_name = '主数据案例'
        # line_colors_sheet_name = '线路颜色标识案例'
        # station_mapping_sheet_name = 'L&E站点匹配案例'
        # env_info_code = 'mam-test'
    ...
    generator = Mam_e_master_data_generator(file_dir, master_data_sheet_name, line_colors_sheet_name,
                                                station_mapping_sheet_name, connection_parameters, env_info_code, user)
    export_file_dir = r'C:\Users\lucy.wu\OneDrive - JCDECAUX\Documents\GitHub\mam-python\MAM E版本升级_WYK82.xlsx'
